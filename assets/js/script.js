...
<div class="footer-legal">
  <p style="font-size: 0.65rem; color: #999999e0; line-height: 1.5;">
    ...
    This website is operated in accordance with the laws of the Canada and United States. By using this site, you agree to our <a href="/termsandconditions/">Terms & Conditions</a>, <a href="/privacypolicy/">Privacy Policy</a>, and all applicable disclosures. Usage of this site implies full consent to electronic communication and TCPA contact, including auto-dialed and pre-recorded calls or SMS.<br><br>
 ...
 function insertReviews() {
  const reviewHTML = `
    ...
    <section class="testimonials">
      <img src="/assets/images/amanda-review.png" alt="Dean Testimonial">
      <img src="/assets/images/jian-review.png" alt="Reba Testimonial">
      <img src="/assets/images/marcus-review.png" alt="Patrick Testimonial">
    </section>
